...
# Modified date : 2019-03-20 13:17
# Author : DARREN
# Describe : not set
...
pretrained_model_dict["config"] = config_dict
pretrained_model_dict["merges"] = merges_dict
pretrained_model_dict["model"] = model_dict
pretrained_model_dict["vocab"] = vocab_dict
pretrained_model_dict["data"] = data_dict
pretrained_model_dict["spacy"] = spacy_dict

for item in pretrained_model_dict:
    print(pretrained_model_dict[item])
